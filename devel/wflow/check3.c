...
int main(int argc,char *argv[])
{
   ...
   if (my_rank==0)
   {
      ...
      printf("\n");
      printf("Convergence of the numerical integration\n");
      printf("----------------------------------------\n\n");
   ...
   nplaq=6.0*(double)(NPROC0*L0-1);
   nplaq*=(double)(NPROC1*NPROC2*NPROC3)*(double)(L1*L2*L3);
