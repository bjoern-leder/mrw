...
* License (GPL)
*
* Statistical consistency of mrw2
*
*******************************************************************************/
...
int main(int argc,char *argv[])
{
   ...
   if (my_rank==0)
   {
      ...
      printf("\n");
      printf("Statistical consistency of mrw2\n");
      printf("---------------------------------\n\n");
      ...
      for (isp=0;isp<3;isp++)
      {
         ...
         if (irw==0)
         {
            for (n=0;n<nsrc;n++)
            {
               ...
               ms.d2=dm;
               ms.mu2=mu0+dm;
               z0[n]=mrw2(ms,0,ispp,lnw10,sqnp0,&sqne0,status);
               ...
               ms.d2=dm;
               ms.mu2=-mu0-dm;
               z1[n]=mrw2(ms,1,ispp,lnw11,sqnp1,&sqne1,status);
            }
