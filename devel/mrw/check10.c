...
* License (GPL)
*
* Equivalenz of mrw1eo and rwtm1eo, mrw3eo and rwtm2eo
*
*******************************************************************************/
...
int main(int argc,char *argv[])
{
   ...
   if (my_rank==0)
   {
      ...
      fin=freopen("check10.in","r",stdin);
      
      printf("\n");
      printf("Equivalenz of mrw1eo and rwtm1eo, mrw3eo and rwtm2eo\n");
      printf("-----------------------------------------------------------------------\n\n");
   ...
   for (irw=0;irw<2;irw++)
   {
      ...
      for (isp=0;isp<3;isp++)
      {
         ...
         if (irw==0)
         {
            ...
            start_ranlux(0,8910+isp);
            lnr1=rwtm1eo(dm,isp,&sqn1,status);
         ...
         else if (irw==1)
         {
            ...
            start_ranlux(0,8910+isp);
            lnr0=mrw3eo(ms,ispp,lnrw1,sqnp,&sqn0,status);
            
            start_ranlux(0,8910+isp);
            lnr1=rwtm2eo(dm,isp,&sqn1,status);
         ...
         {            
            ...
            if (irw==0)
               printf("mrw1eo vs. tmrw1eo: ");
            else if (irw==1)
               printf("mrw3eo vs. tmrw2eo: ");
            else if (irw==2)
